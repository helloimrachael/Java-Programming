...
public interface DataBoard<E extends Data> {
    ...
    */  
    ...
    public void removeFriend(String category, String passw, String friend) throws NullPointerException, CategoryDoesNotExistException, InvalidPasswordException, FriendNotFoundException;
     /*
    ...
    */
    ...
    // Restituisce la lista delle categorie presenti in bacheca.
    public ArrayList<String> getCategoryList();
    /*
    REQUIRES: /
    THROWS: /
    MODIFIES: /
    EFFECTS: restituisce la lista delle categorie della bacheca.
    */

    // Stampa la lista dei dati presenti in bacheca.
    public void getDataList();
    /*
    REQUIRES: /
    THROWS: /
    MODIFIES: /
    EFFECTS: Stampa la lista delle dati della bacheca.
    */
}